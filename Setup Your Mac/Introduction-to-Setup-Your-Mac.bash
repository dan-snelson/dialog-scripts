...
#
#   Version 0.0.2, 11-Dec-2022, Dan K. Snelson (@dan-snelson)
#   - Leverages swiftDialog 2.1 to play videos as logged-in user
#   - Updates to "Pre-flight Checks" from Setup Your Mac (1.5.1)
#
####################################################################################################
