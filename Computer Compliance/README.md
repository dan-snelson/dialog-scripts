...
The following compliance checks and information reporting are included in version `1.8.0`, which operates in "test" mode by default. (Change `operationMode` to `production` before deploying in production.)
